...
public class Front_3 extends OpMode {
    ...
    private final Pose shootPose = new Pose(52.3362831858407, 91.78761061946905, Units.degreesToRadians(180)).mirror();
    private final Pose offlinePose = new Pose(44.3716814159292, 44.3716814159292, Units.degreesToRadians(180)).mirror();
